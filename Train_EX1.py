...
INPUT_FOLDER = r"E:\Mahmoud\Exams\46\462\New-papers\Paper6\NewDataSets\Data1\EX1"
EPOCHS = 20
BATCH_SIZE = 16
LR = 1e-4
...
def train_model():
    ...
    train_set = EyeTrackingDataset(os.path.join(INPUT_FOLDER, "train.csv"))
    val_set = EyeTrackingDataset(os.path.join(INPUT_FOLDER, "val.csv"))
