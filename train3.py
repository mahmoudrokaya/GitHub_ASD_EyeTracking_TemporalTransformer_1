...
from model3 import TemporalTransformerModel
...
OUTPUT_FOLDER = r"E:\Mahmoud\Exams\46\462\New-papers\Paper6\NewDataSets\Data1\Experiment3\Results"
...
def train_model():
    ...
    model = TemporalTransformerModel(input_dim=2, dropout=0.4).to(device)
